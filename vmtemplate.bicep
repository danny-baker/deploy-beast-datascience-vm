// This compiles into an ARM JSON template to build a nice happy vm (port 22 open by default)

// vm specs
var vmSize = 'Standard_D4s_v3'  // View available vm types with 'az vm list-skus -l centralus --output table' from azure CLI
var osDiskSize = 256            // size in GiB
...
var vmPort8000 = 'Allow'    //'Allow' or 'Deny' (JHUB)
var vmPort8787 = 'Allow'    //'Allow' or 'Deny' (RSTUDIOSERVER)
...
// access (these params are passed in at deployment)
@secure() 
