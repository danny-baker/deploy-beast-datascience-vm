...
- 4 cores
- 32GB ram
- 150GiB SSD temp (lasts a few days)
- TiB Premium SSD disk 

This will burn $10USD credit/day and you can run it full throttle (no cpu constraints, full exclusive access) for 20 days until credit depletes.
